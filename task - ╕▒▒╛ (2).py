...
def waypoint_create(_midpoint):
    ...
    _waypoint_list.append([midpoint_cal(_midpoint_list[0], [CAP_LENGTH/2, CAP_LENGTH/2], MIDPOINT_DIS), MIDPOINT_DIS, MIDPOINT_VELOCITY])
    for i in range(0, len(_midpoint_list) - 1):
        ...
        for j in range(1, _waypoint_num):
            ...
            ratio_3 = ((j / _waypoint_num)) * ((j / _waypoint_num)) * ((j / _waypoint_num)) * ((j / _waypoint_num)) * (
            (j / _waypoint_num)) * ((j / _waypoint_num))
        ...
        _waypoint_list.append([midpoint_cal(_midpoint_list[i+1], _midpoint_list[i], MIDPOINT_DIS), MIDPOINT_DIS,
                               MIDPOINT_VELOCITY])
